...
**Branch-protection reality (2026-07-12).** `gh api repos/.../branches/main/protection` returns 404 - main is NOT protected. The "no direct commits to main" claim above is a discipline commitment, not mechanical enforcement. The migration-gate hardening proposal would benefit from actual branch protection first.
