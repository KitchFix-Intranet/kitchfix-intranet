...
export const QUESTIONS = [
  ...
  { id: "3.3", section: 3, category: "Moderate synthesis", question: "What's projected vs actual on TBJ-FL's homestand?", expected: "ANSWER", gating: true, money: false, safety: false, ui: true, runTwice: false, note: "B2 - no-entry days distinct from zero (TBJ-FL is PDC, so structural-absence answer also valid)" },
