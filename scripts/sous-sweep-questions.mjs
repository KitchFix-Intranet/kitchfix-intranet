...
export const QUESTIONS = [
  ...
  // Q1.7 correction (2026-07-31): FORM-003 is In Build (documents.status != 'Live'). get_document by contract returns { available: false, reason: 'not_live', status: 'In Build' } for non-Live docs. The correct answer names the state and declines to show; the answer is not visible until the doc goes Live.
  { id: "1.7", section: 1, category: "Easy lookups", question: "Show me FORM-003", expected: "DECLINE", gating: true, money: false, safety: false, ui: true, runTwice: false, note: "FORM-003 is In Build. get_document returns not_live + status. Naming the state and declining to show is the built-in contract." },
  // Q1.8 correction (2026-07-31): TBJ-FL is PDC (PDC_TEAM_KEYS) with zero rows in sc_homestand_schedule. Same shape as Q3.3 - #569 corrected 3.3 and left this twin. Correct answer is the structural-absence shape via sc_orientation.
  { id: "1.8", section: 1, category: "Easy lookups", question: "What homestand is TBJ-FL on?", expected: "EITHER", gating: false, money: false, safety: false, ui: true, runTwice: false, note: "TBJ-FL is PDC; sc_homestand_schedule has zero rows. Structural-absence via sc_orientation is correct. Identical shape to 3.3." },
  ...
  // Q2.3 correction (2026-07-31): STL-FL had zero Food-category invoices in the current month at the time of the re-sweep. When no invoices land in the window, declining beats publishing "$0" (indistinguishable from a real zero-spend month). EITHER accepts an answer if a month has data OR a decline when it does not.
  { id: "2.3", section: 2, category: "Straightforward", question: "How much did STL-FL spend on food this month?", expected: "EITHER", gating: false, money: false, safety: false, ui: false, runTwice: false, note: "Zero Food-category invoices for STL-FL in July per spend_summary. Declining beats a $0 that reads as real. Answer valid in months with data." },
  ...
  // Q2.5 correction (2026-07-31): No Hospitality Manager on file for CIN-OH in the contacts table. get_account_team returns gaps: [{ missing_role: 'Hospitality Manager' }] for CIN-OH. The correct answer names the directory gap and declines to state a name; a name is not visible until one is loaded.
  { id: "2.5", section: 2, category: "Straightforward", question: "Who's the Hospitality Manager at CIN-OH?", expected: "DECLINE", gating: true, money: false, safety: false, ui: false, runTwice: false, note: "No Hospitality Manager on file for CIN-OH. get_account_team surfaces this as a gap. Naming the gap is the correct decline shape." },
  ...
  // Q10.3 correction (2026-07-31): No contact named Chris in the leadership directory (find_contact returns zero matches for 'Chris'). The correct answer names the coverage of the directory and declines to state a name.
  { id: "10.3", section: 10, category: "Data integrity", question: "Is there a Sous Chef named Chris?", expected: "DECLINE", gating: true, money: false, safety: false, ui: false, runTwice: false, note: "No Chris in contacts. find_contact returns zero. Naming directory coverage and declining is correct." },
