// Emit the CEO one-pager markdown file. Reads _analysis3b.json.

import fs from "node:fs";
import { P, ACCOUNTS } from "./_common3b.mjs";
...
**Does NOT prove:** whether any mix is right for its service program. Whether protein-heavy = expensive-per-meal (July meals denominator at STL is projected, not stable).
...
fs.writeFileSync(P.CEO, doc);
console.log("[3b-ceo] wrote", P.CEO);
console.log("---");
console.log(doc);
