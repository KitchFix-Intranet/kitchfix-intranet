...
//      purchasing-3 migration - INV-P10 found bill headers carry NO
...
async function refreshVendors() {
  ...
  // new tables via purchasing-3 REVOKE).
  ...
  // across pages (defensive - v3 pagination is offset-based and
  // could double-emit on a mid-walk mutation).
