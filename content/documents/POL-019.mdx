...
- We hold what we're required to hold - KitchFix maintains operating permits and licenses required for each site's jurisdiction.
...
- Client-held permits - each site works with their client and is aware of what permits and licenses the client holds for the facility we operate in.
...
The specific requirements by site and jurisdiction are managed by the Finance team - reach out to Finance with questions.
