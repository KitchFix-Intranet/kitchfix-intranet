...
# Source file (JD TEMPLATE - Culinary Delivery Driver.docx) has no doc ID. TPL-104 is a
# CONVERSION CHOICE pending Kevin's CK-2 confirmation. The audit (E_FORM_REF_JD.md)
# recommended TPL-NNN assignment for the four JD TEMPLATEs. Source brand-promise wording
# preserved verbatim despite drift from canonical "Best Food, Best Service, Best Hospitality"
# (audit-flagged).
id: TPL-104
