...
|---|---|---|---|
| A-6 | STL-FL SF is **NON-TAXABLE** (bills TAX 0.00). Confirmed by invoice + Kevin ruling + Josh/Lessard Slack. Cardinals' asserted legal position; Cardinals bear the liability risk. | CLOSED | §U, §Y |
| $24,500 credit | The "prior payment" on K300168343 = a 2025 tax-matter credit, applied as a "payment" line against the SF installment. Credits offset future installments (not separate refunds). | CLOSED | §W, §X |
| Fee figure | 2026 Florida Services Fee = $1,400,000 (finance + invoice confirmed); $900K passthrough + $30K upkeep separate. | CLOSED | §W |
| Upkeep ownership | The $30K upkeep envelope is a **Cardinals-reimbursed passthrough** (KitchFix spends, Cardinals reimburse) - NOT KitchFix-borne. | CLOSED | Kevin |
| Full passthrough | ALL food/snacks/beverages at STL-FL are reimbursable passthrough (the $900K stream). | CLOSED | Kevin |
| Reimbursable tax | Reimbursables bill tax-zero (tax paid to vendors already; avoids double-tax). General rule. | CLOSED | §X |
# Open Items
