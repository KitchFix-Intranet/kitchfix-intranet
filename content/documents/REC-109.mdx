...
- **MLB Dinner**: contract SOW #1 lists MLB Breakfast + Lunch only; PG carries `MLB Dinner` @ $28.58. Operationally served at the same rate (in the missing 2026 SOW). *Kevin 2026-07-16*
...
- **NONE.** No food/packaging/supplies passthrough - ingredient/supply costs are borne by KitchFix, baked into the per-meal rate. *digest §B.7*
...
|---|---|---|
| Model | CLOSED | §W, §Z, digest |
| Deposit | CLOSED | §W |
| Rates | CLOSED | §W, invoices |
| Tax | CLOSED | invoices |
| MLB Dinner | NOTED | Kevin |

**Detail**

- **Model** - 20% deposit-triggered discount + fixed 2.5%/yr escalation. `actuals_drive_invoice` - deposit out-of-band, not in PG.
- **Deposit** - 2026 Annual Deposit = $301,623 (3× $100,541 Jan/Feb/Mar), finance-confirmed. Not a PG fee cell.
- **Rates** - Post-deposit: MLB $28.58, MiLB $14.29, Pre-Game Hot Snack $10.93, Regular Snack $5.89. All invoice-confirmed.
- **Tax** - AZ 9.5% (Surprise) on meals/snacks, invoice-confirmed exact.
- **MLB Dinner** - Contract lists MLB B+L only; PG has MLB Dinner @ $28.58 (operationally served, same rate).
# Open Items

| Item | Status | Owner | Blocking cert? |
|---|---|---|---|
| Deposit golden seed | PENDING | accounting | Phase E only |
| 2026 SOW | OPEN (paperwork) | Kevin | No |
| Continental Breakfast 2026 price | OPEN (minor) | Kevin | No |
| $75K kitchen equipment double-count | OPEN (cost only) | Kevin | No |

**Detail**

- **Deposit golden seed** - 2026 deposit installment invoice ($100,541) not sampled - would confirm the deposit line's tax + labeling. Amount finance-confirmed (§W).
- **2026 SOW** - Master + 2.5% escalation determines 2026 rates (invoice-confirmed); only the deposit dollar amount needed the SOW, and finance §W supplies it. Low-priority memorialization.
- **Continental Breakfast 2026 price** - 2022 SKU dropped in the 2025 SOW; PG carries it - verify the 2026 price.
- **$75K kitchen equipment double-count** - Appears in both 2022 + 2025 agreements as fresh commitment - verify one-spend-restated vs genuine second obligation. KitchFix capex, no billing impact.
