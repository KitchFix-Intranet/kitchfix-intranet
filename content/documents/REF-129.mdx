...
> **[2026-08-11 WITHDRAWAL NOTE]** The "75% of CPI (Food Away from Home)" escalation mechanic previously derived in §B.4, §C, and §D of this digest is UNVERIFIED and MUST NOT be used. Prior derivations from that mechanic (§C escalated-rate cells, §D "Escalation is 75% of CPI" claim) are struck. See §B.4 for the full withdrawal note; see also Track-2 KAD `TBR-FL/decisions_log.md` 2026-08-11 correction. Verbatim contract quotes in §B.4 are preserved as source-of-record text but are no longer treated as a certified extraction until a direct read of the signed agreement is completed (owners: Joe Lessard / Josh Katt).
...
**`Services Agreement Major League Foodservice CJK Foods LLC dba Kitchfix 2024 Josh.pdf`**

- **Doc type** - Base Services Agreement - MLB Foodservice
- **Effective date** - January 1, 2024
- **Execution date** - November 16, 2023
- **Signatories** - Rays Baseball Club LLC: John P. Higgins (Senior VP of Administration/General Counsel); CJK Foods LLC d/b/a Kitchfix: Joshua Katt (CEO)
- **STATUS** - OPERATIVE for 2026 (Retention Period terminates October 1, 2026)

**`Major League SOW 2024 EXECUTION Josh.pdf`**

- **Doc type** - Statement of Work #1 (Major League Foodservice)
- **Effective date** - January 1, 2024
- **Execution date** - November 16, 2023
- **Signatories** - Rays: John P. Higgins; Kitchfix: Joshua Katt (CEO)
- **STATUS** - OPERATIVE for 2026 (SOW Term coincides with Agreement Term; annual CPI-indexed rates continue post-2024 per § 6(a)(i)(c)-(d))

**`Services Agreement Minor League Foodservice CJK Foods LLC dba Kitchfix 2024 Josh.pdf`**

- **Doc type** - Base Services Agreement - MiLB Foodservice
- **Effective date** - January 1, 2024
- **Execution date** - November 16, 2023
- **Signatories** - Rays: John P. Higgins; Kitchfix: Joshua Katt (CEO)
- **STATUS** - OPERATIVE for 2026 (Retention Period terminates December 31, 2026)

**`Minor League SOW 2024 EXECUTION Josh.pdf`**

- **Doc type** - Statement of Work #1 (Minor League Foodservice)
- **Effective date** - January 1, 2024
- **Execution date** - November 16, 2023
- **Signatories** - Rays: John P. Higgins; Kitchfix: Joshua Katt (CEO)
...
> **[WITHDRAWN 2026-08-11 - DO NOT USE]** The "75% of CPI (Food Away from Home)" escalation mechanic was a misreading of prior documentation and is not a verified contract term. The actual escalation basis is **UNVERIFIED pending a direct read of the signed agreement** (owners: Joe Lessard / Josh Katt). Until that read happens, no escalation mechanic may be stated to the client, printed in any deck or proposal, or used in any internal comparison or projection. The verbatim block-quotes below were extracted in prior work and are retained here for reference but are not to be relied on as certified contract text until the direct read is complete.
...
> **[WITHDRAWN 2026-08-11 - DO NOT USE]** The 2025 and 2026 escalated-rate derivations in this table were built on the "75% of CPI (Food Away from Home)" mechanic - see §B.4 withdrawal note. The 2024 base rates row remains as extracted from the SOW; the escalated-rate rows are struck and no substitute value is provided. Actual escalation basis is UNVERIFIED pending a direct read of the signed agreement.

Only 2024 SOWs are physically in the folder. ~~Rates for 2025 / 2026 derive from CPI-adjusted 2024 base per the escalation clause (B.4).~~ [STRUCK 2026-08-11: derivation basis is UNVERIFIED - see §B.4 withdrawal note.] No separate 2025 or 2026 SOW documents exist in the folder.
...
| 2025 | ~~2024 rate x (1 + 0.75 x delta-CPI Nov23->Nov24)~~ [STRUCK 2026-08-11: UNVERIFIED] | ~~same~~ [STRUCK] | ~~same~~ [STRUCK] | ~~same~~ [STRUCK] | ~~same~~ [STRUCK] | ~~same~~ [STRUCK] | NOT PRESENT (no 2025 SOW in folder) | ~~MLB SOW § 6(a)(i)(c)-(d); MiLB SOW § 6(a) v-vi~~ [see §B.4 withdrawal] |
| 2026 | ~~2025 rate x (1 + 0.75 x delta-CPI Nov24->Nov25)~~ [STRUCK 2026-08-11: UNVERIFIED] | ~~same~~ [STRUCK] | ~~same~~ [STRUCK] | ~~same~~ [STRUCK] | ~~same~~ [STRUCK] | ~~same~~ [STRUCK] | NOT PRESENT (no 2026 SOW in folder) | ~~(per B.4 mechanic)~~ [STRUCK] |
...
- ~~**Escalation is 75% of CPI (Food Away From Home - Full Service Meals and Snacks), not 100%** - materially different from TBJ FL which uses 100% of CPI (Food Away From Home). If Price Review v3 assumes uniform 100% CPI, TBR is a mis-model.~~ **[WITHDRAWN 2026-08-11 - DO NOT USE]** The 75%-of-CPI escalation mechanic was a misreading of prior documentation and is not a verified contract term. The actual escalation basis is UNVERIFIED pending a direct read of the signed agreement (owners: Joe Lessard / Josh Katt). Until that read happens, no escalation mechanic may be stated to the client, printed in any deck or proposal, or used in any internal comparison or projection. Do NOT compare TBR-FL escalation to TBJ-FL until TBR's true basis is verified at source.
