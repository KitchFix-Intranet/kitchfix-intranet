...
> **[2026-08-11 WITHDRAWAL NOTE]** The TBR-FL "Escalation" line ("75% x CPI-U Food Away - Full Service Meals & Snacks / SEFV01 / November reset") was WITHDRAWN 2026-08-11 as an unverified claim. Actual escalation basis is UNVERIFIED pending a direct read of the signed agreement. Both this MDX and the generator (`scripts/generate-price-book.mjs`) have been updated. See TBR-FL section below and REF-129 §B.4 withdrawal note.
