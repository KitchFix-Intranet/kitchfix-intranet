...
> **Note (2026-08-13):** The TBR-FL "Escalation" line below was briefly withdrawn on 2026-08-11 as unverified and has been restored - it is accurate per the 2024 agreement. Both this MDX and the generator (`scripts/generate-price-book.mjs`) have been reverted. A source read of the signed clause is still outstanding; record the reader and date here when it happens.
