...
**`Boys and Girls Club Contract 25_26 (1).pdf`**

- **Doc type** - Catering Contract (5 pages: contract body pp.1-3 + Exhibit A Scope-of-Work / CCFP Meal Pattern p.4 + sample dinner menu p.5)
- **Effective date** - Start Date August 19, 2025 → End Date May 21, 2026
- **Execution date** - "made on August 3, 2025" (per §I preamble)
- **Signatories** - Josh Katt (CJK Foods, LLC dba KitchFix) + **"Lynn Dorler"** [ILLEGIBLE handwritten signature, best-guess from print-name line] (Boys and Girls Club of Charlotte County)
- **STATUS** - **OPERATIVE for the 2025-26 school year ONLY.** Term ends **May 21, 2026**. Anything past that date requires a new SOW/renewal not in this doc.
...
- **Meal-type flag - the ledger banked BGC as "$6.50/lunch," but the contract + sample menu suggest DINNER or after-school evening service, NOT lunch.** Evidence:
