...
**`2025-26 Reds-KitchFix Food Services Agreement.pdf`**

- **Document type** - Base Food Services Agreement (multi-year: 2025 + 2026 MLB Seasons, with option to extend through 2027)
- **Effective date** - November 22, 2024
- **Execution date** - Signed (dates not printed near signatures)
- **Signatories** - Nicholas Krall, President of Baseball Operations (Cincinnati Reds LLC); Josh Katt, CEO (CJK Foods, LLC dba KitchFix)
- **STATUS** - OPERATIVE for 2026 (2026 base $362,500 escalated by CPI-U Aug 2024 → Aug 2025 with floor 1% cap 4%)

**`2026 ABR Conversation Planning.docx`**

- **Document type** - Historical planning notes - internal Kitchfix ABR conversation prep for 2027 lockout / 2027+ restructure ("We would like to make a deal for 2027+ ending the option periods and starting with a locked contract for 2027 including an MSA.")
- **Effective date** - n/a (planning)
- **Execution date** - n/a (not executed)
- **Signatories** - n/a
- **STATUS** - HISTORICAL - NOT EXECUTED, planning notes only
