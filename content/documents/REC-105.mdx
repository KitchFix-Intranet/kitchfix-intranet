...
- **SF description naming** - STL-MO SF invoices read **"Management Fee"** (not "Service Fee"); Activity code still `Service Fees (PFS)`. Bill export must not assume uniform Description strings.
...
| $225K passthrough true-up | UNKNOWN | - | No |
...
- **$225K passthrough true-up** - Savings revert to Cardinals, overage billable; SF-level true-up not specified.
