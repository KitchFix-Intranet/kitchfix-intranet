...
Flat-fee accounts (STL-FL, the MLB flat-fee accounts) do not compute revenue from headcount x price - their per-meal prices may be $0 by design (STL-FL flipped to $0 on 2026-06-16). STL-FL's $1.4M annual fee is spread PHASE-AWARE across the 13 periods in the P&L: **P1 $171,367 · P2 peak $407,375 · P3 $132,755 · P4-P8 $98,915 each (FCL plateau) · P9 $57,267 · P10 $52,061 · P11 $39,046 · P12-P13 $0** (source: `docs/pricing-summit/PL_2026_APPENDIX.md` row R25; year total $1,400,000 exact). Peak lands in **P2**, not P3 - the earlier "P1 $45,553 ... P3 peak" phrasing was off-by-one and is superseded by pricing-summit CONFLICT_REGISTER A-9 / D-3. Drive flat-fee revenue from the fee-schedule / P&L allocation, not from meal math. Detail in `SC_BILLING_MODEL_AUDIT.md` and `sc_fee_schedule`.
