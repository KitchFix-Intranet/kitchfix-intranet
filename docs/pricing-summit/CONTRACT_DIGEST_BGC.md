...
**Source folder:** `/Users/kevinfietek/Downloads/` (as delivered — target repo location would be alongside the other digests in `docs/pricing-summit/` if committed later)
