-- purchasing-3-billcom-vendors.sql
...
-- parsers used by /bills, /chartofaccounts, /classes.
--
...
--    /vendors step included, or the standalone vendors refresh) only
...
-- Expected: equal.
--
-- V6. Coverage - after the sync runs at least once. Reports how many
...
-- time) in Supabase Studio. The migration-gate check on the PR looks
-- for the phrase `applied in Studio: YES` in a comment from an OWNER
-- account.
--
