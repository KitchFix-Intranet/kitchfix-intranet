...
**Escalation:** 75% of CPI-U Food Away from Home - Full Service Meals and Snacks (Nov-to-Nov). Section 6(c) ML SOW / Section 6(a)(v-vi) MiLB SOW. Adjusts both Base and Post service-fee rates. *Note (2026-08-13): briefly withdrawn 2026-08-11 and restored - accurate per 2024 agreement; source read still outstanding.*
