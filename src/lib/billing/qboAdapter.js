...
// QBO base + realm. Same target the diff harness reads, hardcoded
// here so the fence stays stable if env vars drift.
const QBO_PROXY_BASE_DEFAULT = "https://chief.ngrok.app/qbo/v3/company/1219933770";
...
export async function postInvoiceDraft(payload, ctx) {
  ...
  const proxyBase = process.env.QBO_PROXY_BASE || QBO_PROXY_BASE_DEFAULT;
  ...
  const url = `${proxyBase}/invoice?minorversion=75`;
